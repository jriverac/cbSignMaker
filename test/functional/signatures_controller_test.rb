...
class SignaturesControllerTest < ActionController::TestCase
  ...
  test "should create signature" do
    assert_difference('Signature.count') do
      post :create, signature: { client_id: @signature.client_id, description: @signature.description, name: @signature.name }
    end
  ...
  test "should update signature" do
    put :update, id: @signature, signature: { client_id: @signature.client_id, description: @signature.description, name: @signature.name }
    assert_redirected_to signature_path(assigns(:signature))
  end
